...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) { // infinite loop to ask again and again
            ...
            switch(request-1){
                case 0:
                    ...
                    User user = userList.get(userId); // get the user ID from the input scanner
                ...
                case 1:
                    ...
                    System.out.println("Please provide user name that you would like to search"); // looks for user expenses
